...
<div class="max-w-7xl mx-auto">
  ...
  <FAQuestion>
    ...
    It usually runs over a weekend and is a great way to learn new skills, meet new
    people, and have fun!
  </FAQuestion>
  <FAQuestion>
    {#snippet question()}
  ...
  <FAQuestion>
    ...
    <a href="mailto:info@camgamejam.com" class="theme-hyperlink"
      >info@camgamejam.com</a
