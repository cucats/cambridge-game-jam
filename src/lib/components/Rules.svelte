<div class="max-w-7xl mx-auto">
  ...
  <ul class="pl-8 list-disc">
    ...
    <li>
      Staying after hours is done so at your own risk and subject to Lab opening
      times!
    </li>
    <li>
  ...
  <ul class="pl-8 list-disc">
    <li>
      All work on projects must be done at the game jam. Using existing open
    ...
    <li>
      ...
      the code in the game jam is against the spirit of the rules and is not
      allowed.
    </li>
    <li>
      ...
      code is fine, but asking one to generate a whole game or the core logic of
      your game is not allowed. Images generated by external (not part of your
      project) AI models must be credited, but such use is discouraged.
    </li>
    <li>
    ...
    <li>
      Submissions must not require additional software to be installed in order
      to run.
    </li>
    <li>
      You may submit a compressed .zip/.rar/.7zip file if the submission is too
      big for itch.io (itch.io has a 1GB limit).
    </li>
    <li>
